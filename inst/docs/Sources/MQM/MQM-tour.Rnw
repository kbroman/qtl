...
default values. Figure~\ref{NoCofs} displayed a large QTL peak on chromosome 4
...
<<AutoCofactor>>
@
\caption{trait with multiple phenotypes, visualized using mqmplot.singletrait}
\end{figure}
