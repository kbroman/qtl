...
<<augment3>>=
data(multitrait)
sim5 <- simulateMissingData(multitrait,5)
sim10 <- simulateMissingData(multitrait,10)
sim80 <- simulateMissingData(multitrait,80)
@
...
<<augment4>>=
multiaug5 <- mqmaugment(sim5)
multiaug10 <- mqmaugment(sim10,minprob=0.25)
multiaug80 <- mqmaugment(sim80,minprob=0.80)
@
...
<<augmentMinProb>>=
multiaug10minprob <- mqmaugment(sim10,minprob=0.001,verbose=T)
multiaug10minprobImpute <- mqmaugment(sim10,minprob=0.001,unaugmentable="impute",verbose=T)
# nind(multiaug)
...
resultsone5 <- scanone(sim5)
resultsone10 <- scanone(sim10)
resultsone80 <- scanone(sim80)
@
