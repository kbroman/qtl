...
maug_no_cofactors <- mqmscan(maug)
@
...
plot(maug_no_cofactors, m_one, col=c("black", "green"), lty=1:2)
@ 
...
<<>>=
just_markers <- mqmextractmarkers(maug_no_cofactors)
@ 
...
plot(result_multi_1, m_one, col=c("black","green"), lty=1:2)
@
...
plot(maug_no_cofactors, result_multi_1, result_multi_2,
     col=c("black","red","blue"), lty=1:3)
@ 
...
plot(backwardresultmulti, m_one, col=c("black","green"), lty=1:2)
@ 
