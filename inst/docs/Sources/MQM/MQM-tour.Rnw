...
find.marker(multiaug,chr=4,pos=30)
multitoset <- which.marker(multiaug,"D4Mit164")
multicofactorlist <- mqmcofactors(multiaug,toset)
...
multitoset <- c(multitoset,which.marker(multiaug,find.marker(multiaug,1,70)))
multicofactorlist <- mqmcofactors(multiaug,multitoset)
...
plot(result_multi_no_cofactors, result_multi_1, result_multi_2,
     col=c("black","red","blue"), lty=1:3)
@ 
