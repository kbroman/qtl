...
<<MainEffectsD1>>
@
\caption{\Atintro, Show main effect of marker GH.117C on trait X3.Hydroxypropyl using \code{plot.pgx}\label{MainEffectsD1}}
\end{figure}
...
<<epistatic1>>
@
\caption{\Atintro, \code{effectplot} shows possible epistatic interaction between markers GH.117C and GA1 \label{epistatic1}}
\end{figure}
