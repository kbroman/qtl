...
//Needed files
              if(phenofile==NULL){fprintf (stderr, "Please supply a phenotypefile.\n");return 0;}
       printf ("Phenotypes = %s\n",phenofile);
              if(genofile==NULL){fprintf (stderr, "Please supply a genofile.\n");return 0;}
       printf ("Genotypes = %s\n",genofile);
              if(markerfile==NULL){fprintf (stderr, "Please supply a markerfile.\n");return 0;}
       printf ("Markers = %s\n",markerfile);
//Optional files
       if(coffile != NULL){
              printf ("Cofactors = %s\n",coffile);
